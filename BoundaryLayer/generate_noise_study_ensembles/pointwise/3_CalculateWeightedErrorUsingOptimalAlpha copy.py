...
def main():
    noises = np.array([0.02, 0.03, 0.04]) # interesting that bimodality is confined to these low noise points!
    ...
    for i,noise in enumerate(noises):
        ...
        print(f'For Noise {noise} and optimal alpha {optimal_alpha}, best case error for Pointwise DB is {100 * pct_err}%')
